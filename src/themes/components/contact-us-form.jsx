...
import AnimationLeft from '../../themes/sources/assets/graphics/animation.gif'
            ...
            <div className='form-div'>
                <div className="title-text-div">
                    ...
                    <p className="preamble">
                        Please fill out the following form and we’ll get in touch with you within a couple of days. If you want to join us, use <Link className='link' href="">this form</Link> instead.
                    </p>
                </div>
