...
export default function SlackForm() {
    ...
    async function handleSubmit(e) {
        ...
        let errorMessages = {};
        let messageErrorMessage = typeForm === 'share' ?
        ...
        if (!captchaValue) {
            ...
            if (isCaptchaValid) {
                ...
                try {
                    ...
                    setSuccessMessage('Application sent. We’ll get back to you within a couple of days.');
                ...
                >
                    <div className='name-email-div'>
                        ...
                        <div className='right'>
                            ...
                            />
                            {errorMessage.contactEmail ?<p className="error right">{errorMessage.contactEmail}</p> : <p className="error right no-vis">Not visible</p>}
                        </div>
                    </div>
                    ...
                    {!isSubmitting ?
                        ...
                        <PrimaryButton type="submit" title="SEND APPLICATION" disabled={Object.keys(errorMessage).length > 0} />
