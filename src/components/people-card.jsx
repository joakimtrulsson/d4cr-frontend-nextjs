    ...
    return (
        <div className='people-card bg-yellow-50 borderradius--xxs margin--xs'>
            ...
            <div className='text-wrapper margin--s flex flex-column flex-justify-between'>
                <div className=''>
                    <p className='margin--zero heading-4 color-grey-700'>{abbreviateWord(data.fullName, 25)}</p>
                    <p className='margin-tb--xxxs color-yellow-700'>{abbreviateWord(data.role, 20)}</p>
                </div>

                <div className=''>
                    <p className='margin--zero description-text'>{abbreviateWord(`${data.country}, ${data.city}`, 30)}</p>                </div>
