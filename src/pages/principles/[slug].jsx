...
import { fetchMainMenuData, fetchFooterMenuData, fetchPrinciplesSortedByNumber } from '../../graphql'
...
export default function PrinciplesPage(props) {
    ...
    const transformedSubPrinciples = Array.isArray(useIndex?.subPrinciples) ? useIndex.subPrinciples.map(subPrinciple => {
